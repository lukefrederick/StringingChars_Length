...
console.log("String: " + stringOne + " has length: " + lengthOne);
console.log("String: " + stringTwo + " has length: " + lengthTwo);
console.log("String: " + stringThree + " has length: " + lengthThree);
